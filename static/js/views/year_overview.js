...
export function getActualSavingsValue(md, accountName, cfg) {
  if (!md) return null;
  if (accountName === 'ALL') {
    let aSum = 0;
...
export function getPlannedSavingsValue(md, accountName, cfg) {
  if (!md) return 0;
  if (accountName === 'ALL') {
    let pSum = 0;
...
export function getAllHistoricalSavingsActuals(accountName, cfg, visibleMonths = []) {
